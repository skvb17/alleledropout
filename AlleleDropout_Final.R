...
getwd()
setwd("~/Desktop/Shannel-project//alleledropout")
load("~/Desktop/Shannel-project//alleledropout/Rori's Database.Rdata")
...
p2 + labs(colour = "Profiles") + ylab("Profile Matches") + xlab("Alleles") + ggtitle("Dropout at One to Thirteen Random Allele(s) ( N = 13 )", subtitle = NULL)
